def create_dealer_card(first: bool, num: number):
    global card_number, dealer_card, dealer_ace, _10_j_q_k, hidden_dealer_card
    if first == False:
...
def dealer_draw_cards():
    ...
    while True:
        ...
        pause(100)
def start_game():
    global dealer_ace, player_ace, can_start_game, player_sum, dealer_sum, draws, dealer_draws
    if can_start_game:
        dealer_ace = 0
        player_ace = 0
